...
namespace Practica_2
{
	class Program
	{
		public static void Main(string[] args)
		{
			...
			per1=new Alumno(num,num2,"Armando",num2);
			per2= new Alumno(num,num2,"Papastatopulos",num);
			Console.WriteLine(per1.sosIgual(per2));
			Console.WriteLine(per1.sosMenor(per2)); 
			Console.WriteLine(per1.sosMayor(per2));
